...
async function main() {
    ...
    // Width/Height from header
    const width = 108; 
    const height = 100; // Safe guess
    ...
    await img.writeAsync('web/public/assets/test/buffalo_eol_test.png');
    console.log("Saved buffalo_eol_test.png");
}
