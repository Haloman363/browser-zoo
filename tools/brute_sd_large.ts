...
async function main() {
    ...
    if (!fs.existsSync('web/public/assets/sd_large')) fs.mkdirSync('web/public/assets/sd_large', { recursive: true });

    for (let w = 100; w <= 120; w++) {
        ...
        await image.writeAsync(`web/public/assets/sd_large/w${w}.png`);
    }
}
